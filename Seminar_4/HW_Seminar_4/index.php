...
$name = 'Yulia';
$profession = 'Analitica';
$sity = 'Omsk';
$e_mail = 'imail@mail.ru';
$telephone = '+7343434564';
...
$work = [
    [
        'names' => 'Заместитель диретора по техническо части',
        'star_date' => 'Июль 2019',
        'stop_date' => 'По настоящее время',
        'about_work' => 'Делаю важные дела.',
    ],
    [
        'names' => 'Старший инженер',
        'star_date' => 'Июль 2017',
        'stop_date' => 'Февраль 2019',
        'about_work' => 'Работа. Еще лучше чем была до этого',
    ],
    [
        'names' => 'Инженер',
        'star_date' => 'Декабрь 2013',
        'stop_date' => 'Ноябрь 2016',
        'about_work' => 'Работа. Хорошая работа',
    ],
];
?>
          ...
          <div class="w3-container">
            ...
            <?php for($i = 0; $i < count($skills); $i ++):?>
                ...
                <div class="w3-light-grey w3-round-xlarge w3-small">
                  <div class="w3-container w3-center w3-round-xlarge w3-teal" style="width:<?= $skills[$i]['percrnt'];?>%"><?= $skills[$i]['percrnt'];?>%</div>
                </div>
            <?php endfor;?>
            <br>
        ...
        <div class="w3-container w3-card w3-white w3-margin-bottom">
          ...
          <div class="w3-container">
              <?php for ($i = 0; $i < count($work); $i ++):?>
                <h5 class="w3-opacity"><b><?=$work[$i]['names'];?></b></h5>
                <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?= $work[$i]['star_date'];?> - <span
                    class="w3-tag w3-teal w3-round"><?= $work[$i]['stop_date'];?></span></h6>
                <p><?= $work[$i]['about_work']?></p>
                <hr>
            <?php endfor;?>
          </div>
